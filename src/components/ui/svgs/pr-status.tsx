...
export const CONTRIBUTION_STATUSES = ["open", "merged", "draft"] as const;
export type ContributionStatus = (typeof CONTRIBUTION_STATUSES)[number];

const GitPullRequestOpenIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
...
export function PrStatusIcon({
  ...
  className,
  ...props
}: SVGProps<SVGSVGElement> & { status: ContributionStatus }) {
