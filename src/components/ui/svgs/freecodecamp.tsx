...
const FreeCodeCampLogo = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <g>
      <g>
        <g>
          <use fill="currentColor" fillOpacity={1} opacity={1} xlinkHref="#a1UGBK5Jf" />
          <g>
            <use fillOpacity={0} stroke="currentColor" strokeOpacity={0} strokeWidth={1} opacity={1} xlinkHref="#a1UGBK5Jf" />
          </g>
        </g>
        <g>
          <use fill="currentColor" fillOpacity={1} opacity={1} xlinkHref="#a8LR3SBcZL" />
          <g>
            <use fillOpacity={0} stroke="currentColor" strokeOpacity={0} strokeWidth={1} opacity={1} xlinkHref="#a8LR3SBcZL" />
          </g>
        </g>
        <g>
          <use fill="currentColor" fillOpacity={1} opacity={1} xlinkHref="#eYLbcOweH" />
          <g>
            <use fillOpacity={0} stroke="currentColor" strokeOpacity={0} strokeWidth={1} opacity={1} xlinkHref="#eYLbcOweH" />
          </g>
        </g>
      </g>
    </g>
